...
comparison_files_paths = ['processed_llama_answers.json', 'processed_my_llama_answers.json','paper1.json','clip_similarities.json','clip_text_similarities.json', 'sem_sim_data_all237_minilm.json','sem_sim_wiki.json'] 
